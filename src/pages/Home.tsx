...
import { focuseSearch, toggleDatePicker } from "../store/actions/actionCreator";
...
import DatePickerBtn from "../components/elements/buttons/DatePickerBtn.tsx";
...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="lg:grid lg:grid-cols-repeat-4-20 gap-6 lg:py-4 justify-center">
        <div className="col-span-4 no-button-scroll relative">
          <DatePickerBtn />
        </div>
